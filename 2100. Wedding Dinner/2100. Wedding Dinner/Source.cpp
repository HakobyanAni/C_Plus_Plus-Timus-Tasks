...
// The alarm went off and the thief hurried away.The next night the thief decided to try the code 0001, then 0002, and 
// so on in ascending order of the number.
...
// Input
// The first line contains the combination that opens the first lock and the second line contains the combination 
// that opens the second lock.Both combinations are strings consisting of four digits from 0 to 9.
